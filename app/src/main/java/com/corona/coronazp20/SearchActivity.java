...
public class SearchActivity extends AppCompatActivity {
    public static final String COVID_API = "https://www.thecocktaildb.com/api/json/v1/1/search.php?s=Margarita";
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            if (margaritaListByCountry.size() == 0) {
            ...
            adapter = new Adapter(SearchActivity.this, margaritaListByCountry);
